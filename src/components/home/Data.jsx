...
const Data = () => {
  return (
    ...
    <p className="home__description">Passionate frontend developer skilled in ReactJS, dedicated to crafting seamless user experiences. Also, a committed practitioner of data structures, enhancing problem-solving skills for optimized code.</p>
